...
CallExprNoIn
    ...
    | CallExprNoIn '.' LENGTH
        {
            $$ = $1 + ',{\"statement\":\"NativeArrayLength\",\"Value\":[]}';
        }
    | '.' IDENT
        {
    ...
    | '.' LENGTH
        {
            $$ = '{\"linea\":\"'+(yylineno+1)+'\",\"statement\":\"NativeArrayLength\",\"Value\":[]}';
        }
    | ArrList
        {
...
Iteration_statements
    ...
    {
        $$ = '{\"linea\":\"'+(yylineno+1)+'\",\"statement\":\"dowhile\",\"body\":['+$5+'],\"Expression\":['+$3+']}';
    }
...
CallExpr
    ...
    | CallExpr '.' LENGTH
    {
        $$ = '{\"linea\":\"'+(yylineno+1)+'\",\"statement\":\"nativeArray\", \"padre\":['+$1+'],\"native\":\"length\"}';
    }
    ;
...
PostfixExpr
    ...
    {
        $$ = '{\"linea\":\"'+(yylineno+1)+'\",\"linea\":\"'+(yylineno+1)+'\",\"statement\":\"postincrement\",\"padre\":['+$1+']}';
    }
